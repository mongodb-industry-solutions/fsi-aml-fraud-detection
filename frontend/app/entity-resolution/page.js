...
const EntityResolutionPage = () => {
  ...
  const handleMatchesFound = (data) => {
    ...
    if (data.searchDuration) {
      setSearchMetrics({
        ...
        search_fields: ['name.full', 'addresses.full', 'dateOfBirth', 'identifiers.value'].filter(field => {
          const inputData = data.inputData || {};
          return inputData.name_full || inputData.address_full || inputData.date_of_birth || inputData.identifier_value;
        })
      });
    }
  };
  ...
  const handleResolutionAction = async (action, entityIds) => {
    console.log(`Resolution action: ${action} for entities:`, entityIds);
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center', flex: 1 }}>
              <div style={{ marginBottom: spacing[3] }}>
                <Icon glyph="University" size="large" fill={palette.blue.base} />
              </div>
              <H1 style={{ 
              ...
              <Body style={{ 
                ...
                Advanced AML/KYC onboarding with MongoDB Atlas Search fuzzy matching. 
                Detect potential duplicates and resolve entity relationships with AI-powered intelligence.
              </Body>
            </div>
            ...
            <div style={{ 
              ...
              <Badge variant={useEnhancedView ? 'green' : 'lightgray'}>
              ...
              <Button 
                ...
                leftGlyph={<Icon glyph={useEnhancedView ? "Megaphone" : "University"} />}
              >
                {useEnhancedView ? 'Switch to Standard' : 'Switch to Enhanced'}
              </Button>
      ...
      <div style={{ 
        ...
        {matchesData && (
          <div>
            <div style={{ 
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: spacing[2] }}>
                {matchesData.matches && (
                  <Badge variant="blue" style={{ fontSize: '14px' }}>
                    {matchesData.matches.length} {matchesData.matches.length === 1 ? 'match' : 'matches'} found
                  </Badge>
                )}
          ...
          <div>
            ...
            <Card style={{ 
              ...
              <div style={{ textAlign: 'center' }}>
                <Icon glyph="Checkmark" size="xlarge" fill={palette.green.base} />
                <H2 style={{ 
                  color: palette.green.dark2, 
                  marginTop: spacing[2],
                  marginBottom: spacing[2]
        ...
        <Card style={{ padding: spacing[3] }}>
          <div style={{ 
            ...
            <div style={{
              width: '40px',
              height: '2px',
              backgroundColor: matchesData ? palette.green.base : palette.gray.light2
            }} />
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                color: matchesData ? 'white' : palette.gray.dark1,
                fontWeight: 'bold'
              }}>
                2
              </div>
              <Body style={{ color: matchesData ? palette.gray.dark1 : palette.gray.base }}>
                Find Matches
              </Body>
            </div>
            ...
            <div style={{
              width: '40px',
              height: '2px',
              backgroundColor: selectedEntity ? palette.green.base : palette.gray.light2
            }} />
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                height: '32px',
                borderRadius: '50%',
                backgroundColor: (showWorkbench || resolutionComplete) ? palette.green.base : palette.gray.light2,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                color: (showWorkbench || resolutionComplete) ? 'white' : palette.gray.dark1,
                fontWeight: 'bold'
              }}>
                {resolutionComplete ? '✓' : '3'}
              </div>
              <Body style={{ color: (showWorkbench || resolutionComplete) ? palette.gray.dark1 : palette.gray.base }}>
                {resolutionComplete ? 'Complete!' : 'Resolve Entity'}
              </Body>
            </div>
          </div>
        </Card>
        ...
        <Card style={{ 
          ...
          <div style={{ 
            ...
            <div>
              <Body style={{ fontWeight: 'bold', color: palette.blue.dark2 }}>
                Perfect Match Demo:
              </Body>
              <Body style={{ color: palette.gray.dark1, fontSize: '14px' }}>
                Click "Load Demo Data" to see exact entity matching with Samantha Miller.
              </Body>
            </div>
            <div>
              <Body style={{ fontWeight: 'bold', color: palette.blue.dark2 }}>
              ...
              <Body style={{ color: palette.gray.dark1, fontSize: '14px' }}>
                Click "Fuzzy Match Demo" to see how "Samantha X. Miller" finds similar entities.
              </Body>
            </div>
            <div>
              <Body style={{ fontWeight: 'bold', color: palette.blue.dark2 }}>
              ...
              <Body style={{ color: palette.gray.dark1, fontSize: '14px' }}>
                Try the Enhanced View for advanced sorting, bulk actions, and match intelligence.
              </Body>
            </div>
            <div>
              <Body style={{ fontWeight: 'bold', color: palette.blue.dark2 }}>
              ...
              <Body style={{ color: palette.gray.dark1, fontSize: '14px' }}>
                You should see 2-4 matches including "Sam Brittany Miller" as a potential duplicate.
              </Body>
            </div>
          </div>
        </Card>

...
class TwoStageAgentCore:
    ...
    async def _get_or_create_thread(self, transaction_id: str, customer_id: str = None) -> str:
        """Get existing thread or create new one for conversation memory (MongoDB-backed)"""
